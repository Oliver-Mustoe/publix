...
Start-Process Powershell "-Command ssh-keygen -t rsa -b 4096 -f C:\Users\$env:username\$env:username-jump-keys -C $env:username" -LoadUserProfile -NoNewWindow -Credential $Cred -wait -NoNewWindow
# log off
